...
export class SolanaService {
  ...
  static async getPrice(addresses: [string], currencies: [string]) {
    return await this.rpc(SolanaReqBodyMethod.enhancedGetPrice, [
      addresses,
      currencies,
    ]);
  }
  ...
  static async getTokensAndNFTs(address: string) {
    return await this.rpc(SolanaReqBodyMethod.enhancedGetTokensAndNFTs, [
      address,
    ]);
  }
  static async getTransactionsByAddress(address: string) {
    ...
    return await this.rpc(
      SolanaReqBodyMethod.enhancedGetTransactionsByAddress,
      [address, obj],
    );
  }

  static async getTokenTransactionsByAddress(
    address: string,
    mintAddress: string,
  ) {
    const obj = {address: address, mint: mintAddress};
    return await this.rpc(
      SolanaReqBodyMethod.enhancedGetTokenTransactionsByAddress,
      [obj],
    );
  }

  static async serializeSolTransction(
    from: string,
    to: string,
    amount: string,
  ) {
  ...
  static async serializeSplTokenTransction(
    from: string,
    to: string,
    mint: string,
    amount: string,
