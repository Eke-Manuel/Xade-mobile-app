...
const clearingHouseViewer = new ethers.Contract(clearingHouseViewerAddress, clearingHouseViewerABI.abi, signer);
...
export async function getPositionDetails(amm: string): Promise<any> {
